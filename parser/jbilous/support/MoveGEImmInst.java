...
public class MoveGEImmInst extends Instruction{

	public MoveGEImmInst(int source, int target) {
	...
	public Vector<AssemblyInstruction> genAssembly() {
		...
		inst.add(new CMovGE(new AssemblyRegister(x86_64Reg.R8), new VirtualRegister(target)));
		inst.add(new PopQ(new AssemblyRegister(x86_64Reg.R8)));
		return inst;
	}

	public String toString() {
		return "movge " + source + ", r" + target;
	}
}