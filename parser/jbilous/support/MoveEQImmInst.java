...
public class MoveEQImmInst extends Instruction{

	public MoveEQImmInst(int source, int target) {
	...
	public Vector<AssemblyInstruction> genAssembly() {
		...
		inst.add(new CMovEQ(new AssemblyRegister(x86_64Reg.R8), new VirtualRegister(target)));
		inst.add(new PopQ(new AssemblyRegister(x86_64Reg.R8)));
		return inst;
	}

	public String toString() {
		return "moveq " + source + ", r" + target;
	}
}