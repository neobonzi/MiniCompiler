...
public class MoveLEImmInst extends Instruction{

	public MoveLEImmInst(int source, int target) {
	...
	public Vector<AssemblyInstruction> genAssembly() {
		...
		inst.add(new CMovLE(new AssemblyRegister(x86_64Reg.R8), new VirtualRegister(target)));
		inst.add(new PopQ(new AssemblyRegister(x86_64Reg.R8)));
		return inst;
	}
	
	public String toString() {
		return "movle " + source + ", r" + target;
	}
}