...
public class MoveLTImmInst extends Instruction{

	public MoveLTImmInst(int source, int target) {
	...
	public Vector<AssemblyInstruction> genAssembly() {
		...
		inst.add(new CMovLT(new AssemblyRegister(x86_64Reg.R8), new VirtualRegister(target)));
		inst.add(new PopQ(new AssemblyRegister(x86_64Reg.R8)));
		return inst;
	}

	public String toString() {
		return "movlt " + source + ", r" + target;
	}
}